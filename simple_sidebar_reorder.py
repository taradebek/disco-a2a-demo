...
# Find the three sidebar sections and swap their order
# Current: Agent Status -> Current Step -> Controls
# New: Controls -> Agent Status -> Current Step

# Use a simple string replacement approach
old_order = '''            <!-- Agent Status Panel -->
            <div class="col-md-3">
                <div class="card mb-4">
...
print("Successfully reordered sidebar: Controls -> Agent Status -> Current Step")
